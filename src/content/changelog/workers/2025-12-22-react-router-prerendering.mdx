...
This feature requires `@react-router/dev` v7.x.y or later. See the [React Router framework guide](/workers/framework-guides/web-apps/react-router/#pre-rendering-experimental) for more details.
